        ...
        <!-- HIDDEN TEXT BOX -->
         ...
         <div class="col-md-12">
            <div class="form-group">               
              <br>
                <label >Surname <span class="mb-0 text-primary">*</span></label>   
                ...
                <label >First Name <span class="mb-0 text-primary">*</span></label> 
                  <input type="text" class="form-control" id="firstname" name="firstname" placeholder="Enter First Name" value="<?php echo strtoupper($emp_row['varFirstname']); ?>" required="" >  
              </div>              
         </div>
              ...
              <div class="form-group">
                <label  class="col-sm-3 control-label">Position</label>
                    <select class="form-control" style="width: 100%;" name="position"  id="position">
                      <option selected="selected" value="<?php echo strtoupper($emp_row['intPosition_ID']); ?>"><?php echo strtoupper($emp_row['varPosition']); ?></option>
