...
if(isset($_POST['add_employee'])){
        ...
        $sql = "INSERT INTO tbl_employee (intEmployee_ID,intEmployee_number,varFirstname, varMiddlename, varLastname, enumGender, varExtension_Name, enumCivil_Status, Birth_Date, intPosition_ID, varAddress, intDepartment_ID, enumEmployment_Status, Employment_Date, enumWork_Schedule )
             VALUES ('$employee_id','$employee_number','$firstname','$middlename','$surname','$gender','$extension','$civil_status','$date_of_birth','$position','$address','$department','Active','$employment_date', '$enumscheduletype')";
